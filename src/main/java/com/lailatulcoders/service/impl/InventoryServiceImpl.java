...
public class InventoryServiceImpl implements InventoryService {
    ...
    public void addStock(Product product, int quantity) {
        try {
            ...
            logger.info("[STOCK ADDED] Product: {} | Qty: {} | New Stock: {}",
                    product.getId(), quantity, product.getStockLevel());
    ...
    public void removeStock(Product product, int quantity) {
        try {
            ...
            logger.info("[STOCK REMOVED] Product: {} | Qty: {} | Remaining: {}",
                    product.getId(), quantity, product.getStockLevel());
    ...
    public boolean needsRestock(Product product) {
        try {
            ...
            logger.info("[RESTOCK CHECK] Product: {} | Needs Restock: {}",
